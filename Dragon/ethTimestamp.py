...
class BaseTimestampTransactions:
    ...
    def getMintTimestamp(self, contractAddress, useProxies):
        url = f"https://gmgn.ai/defi/quotation/v1/tokens/base/{contractAddress}"
        retries = 3
    ...
    def getTxByTimestamp(self, contractAddress, threads, start, end, useProxies):
        base_url = f"https://gmgn.ai/defi/quotation/v1/trades/base/{contractAddress}?limit=100"
        paginator = None
        urls = []
        all_trades = []
        ...
        wallets = []
        filename = f"Dragon/data/Base/TimestampTxns/txns_{self.shorten(contractAddress)}__{random.randint(1111, 9999)}.txt"
